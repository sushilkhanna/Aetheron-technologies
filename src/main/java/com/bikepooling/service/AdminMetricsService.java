...
public class AdminMetricsService {
    ...
    public void seedOnStartup() {
        ...
        seedIfAbsent(KEY_TOTAL_USERS, () -> userRepo.countActiveUsers());
        seedIfAbsent(KEY_ACTIVE_RIDES, () -> 0L);
        seedIfAbsent(KEY_RIDES_TODAY, () -> 0L);
        seedIfAbsent(KEY_REVENUE_TODAY, () -> 0L);
    ...
    public long getActiveRides() {
        return getLong(KEY_ACTIVE_RIDES, () -> 0L);
    }

    public long getRidesToday() {
        return getLong(KEY_RIDES_TODAY, () -> 0L);
    }
    ...
    public void onRidePosted(LocalDateTime departAt) {
        ...
        if (departAt != null && departAt.toLocalDate().equals(LocalDate.now())) {
